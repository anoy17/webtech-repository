...
<?php
    ...
    $nameErr = $emailErr = $genderErr = $birthdateErr =  $degreeErr = $bloodgroupErr = $newpassErr = $renewpassErr = $usernameErr = $specialityErr = $scheduleErr = "";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      //Speciality validation//Speciality validation//Speciality validation
    
      if ($_POST["speciality"] == "Select") {
      ...
      if ($check == 8) {
          ...
          $_SESSION['speciality1']=$_REQUEST['speciality'];
          $_SESSION['schedule1']=$_REQUEST['schedule'];
          ...
          header('location:../controller/addDoctorDone.php');
      }
  }
...
<script type="text/javascript" src="../javascript/doctorJavaScript.js"></script>
